...
const INITIAL_DATA: SiteData = {
  ...
  currentStayDetails: "परम पूज्य निर्ग्रन्थ मुनि श्री 108 सुवंद्य सागर जी महाराज ससंघ का पावन चातुर्मास प्रवास एवं स्वाध्याय charyaa",
  ...
  pravachans: [
    {
      ...
      category: "Pravachan",
      description: "मुनि सुवंद्य सागर जी महाराज इस प्रवचन में जीवन और समय के महत्व को समझाते हुए आत्मशुद्धि का मार्ग बताते हैं।",
  ...
  granthBooks: [
    ...
    },
    {
      ...
      description: "आचार्य पूज्यपाद कृत इष्टोपदेश ग्रंथ पर मुनि श्री सुवंद्य सागर जी की प्रांजल टीका।",
  ...
  podcasts: [
    {
      id: "pod1",
      title: "मुनि सुवंद्य सागर जी के संग आध्यात्मिक संवाद",
  ...
  blogs: [
    {
      ...
      snippet: "पूज्य मुनि श्री 108 सुवंद्य सागर जी महाराज ससंघ के आगमन से इंदौर नगरी धर्ममय हो उठी।",
      content: "पूज्य मुनि श्री 108 सुवंद्य सागर जी महाराज ससंघ के इंदौर नगर आगमन पर अपार जनसैलाब उमड़ा। भव्य आगवानी के साथ भक्तजनों ने मुनि श्री का पाद प्रक्षालन कर आशीर्वाद प्राप्त किया।",
      date: "12 Feb 2025",
      author: "श्री सुवंद्य देशना मीडिया संघ"
    },
    {
      id: "blog2",
