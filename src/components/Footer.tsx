        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-amber-200/60 leading-relaxed">
              यह आधिकारिक पोर्टल पूज्य मुनि श्री 108 सुवंद्य सागर जी महाराज के भक्तों द्वारा संचालित है। निष्परिग्रही व्रती जीवन के सिद्धांतों का पूर्ण पालन किया जाता है।
            </p>
          </div>
